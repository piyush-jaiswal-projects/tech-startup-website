...
function Contacts(){
    return(
        ...
        <div class="contact-emails">
            ...
            <h3 class="address-title">Email Us</h3>
            <p class="contact-section-para">
        ...
        <div class="contact-emails contact-social">
            ...
            <h3 class="address-title">Social Media</h3>
            <p class="contact-section-para">
               <a href="https://www.instagram.com"><img class="social-img" alt="instagram" src="media/ig.png"></img></a>
               <a href="https://www.twitter.com"><img class="social-img" alt="twitter" src="media/tw.png"></img></a>
               <a href="https://www.linkedin.com"><img class="social-img" alt="linkedin" src="media/li.png"></img></a>
